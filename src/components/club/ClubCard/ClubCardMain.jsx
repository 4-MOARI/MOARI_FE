  ...
  return (
    <article className="club-card-main">
      ...
      <div className="club-card-meta">
        ...
        <div 
          onClick={toggleLike}
          style={{ width: '24px', height: '21px', cursor: isFavoriteLoading ? 'default' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: isFavoriteLoading ? 0.6 : 1 }}
        >
          <svg width="24" height="21" viewBox="0 0 24 21" fill={isFavorite ? "#D4537E" : "none"} stroke="#D4537E" strokeWidth="2" xmlns="http://www.w3.org/2000/svg">
